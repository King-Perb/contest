module 0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::contest {
...
use 0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::meme;
use 0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::vote_proof;
use 0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::voting_key;
    ...
    struct Contest has key {
        ...
        voting_keys_tab: 0x2::table::Table<0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::voting_key::VotingKey, u8>,
    ...
    friend fun check_double_voting_for_nft_internal(arg0: &mut Contest, arg1: 0x2::object::ID, arg2: address) {
        let v0 = 0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::voting_key::create_voting_key(arg1, arg2);
        assert!(!0x2::table::contains<0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::voting_key::VotingKey, u8>(&arg0.voting_keys_tab, v0), 4);
        0x2::table::add<0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::voting_key::VotingKey, u8>(&mut arg0.voting_keys_tab, v0, 1);
    }
    
    friend fun check_nft_limit_internal(arg0: &mut Contest, arg1: address) {
    ...
    friend fun check_vote_limit_internal(arg0: &mut Contest, arg1: address) {
    ...
    friend fun create_contest(arg0: vector<u8>, arg1: address, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : Contest {
        ...
        Contest{
            ...
            voting_keys_tab        : 0x2::table::new<0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::voting_key::VotingKey, u8>(arg5), 
    ...
    public fun do_delete(arg0: &mut Contest, arg1: vector<u8>, arg2: 0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::meme::MemeNFT, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = create_msg(0x2::tx_context::sender(arg3), 0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::meme::id(&arg2));
        assert!(0x2::bls12381::bls12381_min_pk_verify(&arg1, &arg0.admin_pub_key, &v0), 11);
        update_contest_on_nft_removal_internal(arg0, 0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::meme::id(&arg2));
        0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::meme::burn_meme(arg2);
    }
    ...
    public fun do_mint(arg0: &mut Contest, arg1: 0x1::string::String, arg2: address, arg3: 0x1::string::String, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v0 = 0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::meme::mint_meme(0x2::object::uid_to_inner(&arg0.id), arg1, arg2, arg3, arg0.nft_mint_order, arg4, arg5);
        let v1 = 0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::meme::id(&v0);
        0x2::table::add<0x2::object::ID, u64>(&mut arg0.num_votes_tab, v1, 0);
        0x2::transfer::public_transfer<0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::meme::MemeNFT>(v0, arg2);
        v1
    }
    ...
    public fun do_vote(arg0: &mut Contest, arg1: vector<u8>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xa17b9cc3777aa7d4ffd64206b5b5ff9c14a5170c587ca214ec94c8427f4002e1::vote_proof::create_vote_proof_and_transfer(arg2, arg4);
    }
